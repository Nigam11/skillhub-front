  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 animate-fade-in">
      <main className="flex-grow max-w-5xl mx-auto px-6 py-16">
        <div className="bg-white bg-opacity-90 shadow-xl rounded-2xl p-10 border border-gray-200 backdrop-blur-md">
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-gray-500">Made with ❤️ by the SkillHub team.</p>
          </div>
        </div>
      </main>
    </div>
