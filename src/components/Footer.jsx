  ...
  return (
    <footer className="bg-black text-white py-12 px-6 mt-10">
      ...
      <div className="mt-12 text-center text-gray-500 text-sm space-y-1 px-4">
        ...
        <div>
          Developed by <span className="text-gray-400">Nigam Chaudhary</span>
        </div>
        <div className="text-gray-400 text-xs">
          Contact:{" "}
          <a href="mailto:skillhub.reset@gmail.com" className="hover:underline">
            skillhub.reset@gmail.com
          </a>{" "}
          |{" "}
          <a href="mailto:nigamdangi26@gmail.com" className="hover:underline">
            nigamdangi26@gmail.com
          </a>
        </div>
      </div>
    </footer>
